...
export const SKILLS: Skill[] = [
  {
    ...
    installCommand: `mkdir -p ~/.hermes/skills/productivity/paste-bit64-share && curl -s https://raw.githubusercontent.com/wurong98/paste-markdown/master/skills/paste-bit64-share/SKILL.md -o ~/.hermes/skills/productivity/paste-bit64-share/SKILL.md`,
